...
3. **DS18B20 Temperature Sensor** - Connected via GPIO 26.
4. **SD Card Module** - For logging GPS and temperature data.
5. **Button (optional)** - For toggling GPS activation and entering deep sleep mode.
